...
const TodoForm = ({ onAddTodo }) => {
  ...
  const [textError, setTextError] = useState(""); // Добавляем состояние для ошибки.
